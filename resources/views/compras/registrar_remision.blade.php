...
@section('content')
<div class="max-w-6xl mx-auto" x-data="remisionForm()">
    <!-- Header -->
    <div class="mb-6">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-3xl font-bold text-gray-800">📦 Registrar Remisión</h1>
    ...
    <div class="bg-green-50 border border-green-200 rounded-lg p-4 mb-6">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
                <label class="text-sm text-green-700 font-medium">Proveedor:</label>
                <p class="text-gray-900 font-semibold">{{ $presupuesto->contacto_nombre }}</p>
            </div>
            <div>
                <label class="text-sm text-green-700 font-medium">Empresa:</label>
                <p class="text-gray-900">{{ $presupuesto->contacto_empresa ?? 'N/A' }}</p>
            </div>
            <div>
                <label class="text-sm text-green-700 font-medium">Total Presupuestado:</label>
    ...
    <!-- Formulario -->
    <form method="POST" action="{{ route('compras.registrar-remision', $presupuesto) }}" @submit="validarFormulario">
        @csrf

        <!-- Número de Remisión -->
        <div class="bg-white rounded-lg shadow-md p-6 mb-6">
            <h2 class="text-xl font-bold text-gray-800 mb-4">📋 Datos de la Remisión</h2>
            <div class="max-w-md">
                <label for="remision_numero" class="block text-sm font-medium text-gray-700 mb-2">
                    Número de Remisión del Proveedor <span class="text-red-500">*</span>
                </label>
                <input type="text"
                       name="remision_numero"
                       id="remision_numero"
                       required
                       value="{{ old('remision_numero') }}"
                       placeholder="Ej: REM-2025-001234"
                       class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent">
                @error('remision_numero')
        ...
        <div class="bg-white rounded-lg shadow-md p-6 mb-6">
            <div class="flex items-center justify-between mb-4">
                <h2 class="text-xl font-bold text-gray-800">📦 Cantidades Recibidas</h2>
                <div class="text-sm text-gray-600">
                    <span class="bg-yellow-100 text-yellow-800 px-3 py-1 rounded-full font-medium">
                        Ajusta las cantidades reales recibidas del proveedor
                    </span>
                </div>
            </div>
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th class="px-4 py-3 text-center text-xs font-medium text-gray-500 uppercase">Cant. Real Recibida</th>
                            ...
                            <tr x-data="{
                                ...
                                <td class="px-4 py-3">
                                    ...
                                    <input type="number"
                                           ...
                                           min="0"
                                           required
                                           class="w-28 px-3 py-2 border border-gray-300 rounded-lg text-center focus:ring-2 focus:ring-green-500 focus:border-transparent"
                ...
                <div class="flex items-start">
                    ...
                    <div class="text-sm text-green-800">
                        ...
                        <ul class="mt-1 list-disc list-inside space-y-1">
                            <li>Ingresa las cantidades <strong>realmente recibidas</strong> del proveedor</li>
                            <li>Si hay diferencias (faltantes o sobrantes), explica el motivo</li>
                            <li>Las diferencias se registrarán automáticamente para trazabilidad</li>
                            <li>El inventario se actualizará con las cantidades reales al validar la contrafactura</li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="flex justify-between items-center">
            ...
            <button type="submit"
                    class="px-8 py-3 bg-green-600 text-white rounded-lg hover:bg-green-700 transition font-bold shadow-lg hover:shadow-xl">
                ✅ Registrar Remisión
            </button>
        </div>
    </form>
